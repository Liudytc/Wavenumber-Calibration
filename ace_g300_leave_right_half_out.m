...
%% REFINED SEARCH
d = 1e-3./current_grating;%degree
laser_centre = laser;%degree
laser_range =0e-9;
laser_n = 1;
laser_step_size = 1;%laser_range/(laser_n-1);
...
RMSE_ace_g300_lrh_peaks=[RMSE_e1,RMSE_o1,RMSE_o2,RMSE_o3,RMSE_o4,RMSE_o5,RMSE_o6,RMSE_o7];
STD_ace_g300_lrh_peaks=[STD_e1,STD_o1,STD_o2,STD_o3,STD_o4,STD_o5,STD_o6,STD_o7];
MAE_ace_g300_lrh_peaks=[mean(error1_original1),mean(error2),mean(error3),mean(error4),mean(error5),mean(error6),mean(error7),mean(error8)];